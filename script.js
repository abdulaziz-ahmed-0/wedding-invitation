...
import { getDatabase, ref, push, onValue } from "https://www.gstatic.com/firebasejs/12.17.1/firebase-database.js";
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    openBtn.addEventListener('click', () => {
        ...
        setTimeout(() => {
            ...
            // 2. Start slow auto-scroll to the bottom
            let scrollInterval;
            function startAutoScroll() {
                ...
                }, 30); // Speed of scroll (higher = slower, 30 is very slow/readable)
            }
    ...
    function playAudio() {
        audio.play().then(() => {
            ...
            console.log("Audio playback failed (usually due to browser autoplay policies):", err);
            isPlaying = false;
        });
    }
    ...
    if (!db) {
        const savedWishesInit = JSON.parse(localStorage.getItem('weddingWishes')) || [];
